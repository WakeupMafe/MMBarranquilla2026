import RodillaResultado from "./RodillaResultado";
export default function RodillaFields({
  formData,
  errores,
  handleChange,
  handleSubmit,
      ...
      <form className="valoracionForm" onSubmit={handleSubmit}>
        ...
        <div className="valoracionActions">
          <button
            ...
            disabled={guardando}
          >
            {guardando ? "Guardando..." : "Evaluar rodilla"}
          </button>
        </div>
      </form>
      <RodillaResultado resultado={resultado} />
    </section>
  );
}
