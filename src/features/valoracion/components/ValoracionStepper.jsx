...
export default function FotoUploadTest() {
  ...
  ========================= */
  // ✅ CAMBIO:
  // El flujo correcto para usar cache es cuando viene desde ANAMNESIS ZONA,
  // no desde check-in.
  ...
  ========================= */
  // ✅ CAMBIO:
  // Solo se usa cache de valoracionActiva si realmente viene desde anamnesis-zona.
  // Si entra desde /herramientas, NO trae paciente ni cédula del cache.
  ...
  ========================= */
  // ✅ CAMBIO:
  // Las zonas primero salen del state actual.
  // Solo si viene desde anamnesis-zona se permite respaldo desde cache.
  ...
  ========================= */
  // ✅ CAMBIO:
  // El paciente primero sale del state actual.
  // Solo si viene desde anamnesis-zona puede usar cache.
  // Desde /herramientas debe quedar vacío.
  ...
  // ✅ CAMBIO:
  // La cédula sigue exactamente la misma lógica.
  ...
  // El flujo correcto antes de fotos es anamnesis-zona.
  // Si viene desde allá, devuelve a anamnesis-zona.
  // Si entra desde herramientas, vuelve a herramientas.
  const handleVolver = () => {
